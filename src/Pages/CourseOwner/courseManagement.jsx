...
//   const handleMenuOpen = (event, course, index) => {
//     setMenuAnchor(event.currentTarget);
//     setMenuCourse({ ...course, index });
//   };
...
//         {(() => {
//           // ✅ Filter only logged-in course owner's courses
//           const ownerCourses = courses.filter((c) => c.userID === loggedInUser?.id);

//           // ✅ Group courses by status
//           const grouped = Object.keys(STATUS_LABEL).reduce((acc, statusKey) => {
//             acc[statusKey] = ownerCourses.filter(
