...
const StudentDiscussionPage = () => {
    ...
    useEffect(() => {
        if (!courseId) return;
        const saved =
            JSON.parse(localStorage.getItem(`discussions_${courseId}`)) || [];
        setThreads(saved);
    }, [courseId]);
    ...
    const handleNewThread = (e) => {
        ...
        if (editingThreadId) {
            ...
            const thread = {
                ...
                author: loggedInUser?.firstName || "Student",
                authorId: loggedInUser?.email || "anonymous", // ✅ check ownership
                    ...
                    ? {
                        ...
                        replies: [
                            ...t.replies,
                            {
                                ...
                                text,
                                author: loggedInUser?.firstName || "Student",
                                authorId: loggedInUser?.email || "anonymous",
                                createdAt: new Date().toLocaleString(),
                            },
                        ],
                    }
